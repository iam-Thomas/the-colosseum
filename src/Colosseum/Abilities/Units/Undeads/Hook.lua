...
function AbilityTrigger_Abom_Hook_Actions()
    ...
    TimerStart(timer, 0.03, true, function()
        ...
        for i = 1, #chainEffects do
            ...
            BlzSetSpecialEffectPosition(chainEffects[i], chainX, chainY, 40)
        ...
        BlzSetSpecialEffectPosition(hookEffect, hookX, hookY, 40)
        local hookEffectAngle = AngleBetweenPoints(currentCasterLoc, currentHookLoc)
