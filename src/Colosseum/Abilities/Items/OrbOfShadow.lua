...
RegInit(function()
    ...
    ItemTrigger_OrbOfShadow_Damaged = AddDamagingEventTrigger_CasterHasItem(FourCC('I00E'), ItemTrigger_OrbOfShadow_Damaged_Actions)
end)
...
function ItemTrigger_OrbOfShadow_Damaged_Actions()
    ...
    local bonusDamage = 6.0 + (heroLevel * 0.4)
